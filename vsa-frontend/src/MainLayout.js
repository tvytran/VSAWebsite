      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-[#e0c9a6] shadow-lg px-4 py-4 z-50">
          <div className="bg-white flex flex-col items-center justify-center min-h-[60vh] py-8 mx-auto w-full max-w-xs">
            <Link to={isLoggedIn || isGuest ? "/dashboard" : "/"} className="hover:opacity-90 transition-opacity duration-200 group">
              <img
            ...
            <div className="flex flex-col space-y-3 w-full px-4">
              ...
              {isGuest && (
                <button
                  ...
                  className="w-full py-2.5 mt-4 bg-[#b32a2a] text-white font-medium rounded-lg hover:bg-[#8a1f1f] hover:scale-105 transition-all duration-300 ease-in-out text-base shadow-sm flex items-center justify-center transform"
                >
                  Exit Guest Mode
                </button>
              )}
